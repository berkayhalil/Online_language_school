<div class="topnav" id="myTopnav">
    ...
    <div id="navbar-right">
        <a id="phone-icon" href="tel:+359895881182" onclick="collapseMenu()"><i class="fa-solid fa-phone"></i> <span>089
                588 1182</span></a>
        <a id="home-icon" href="/home" onclick="collapseMenu()"><i class="fas fa-home"></i></a>
        <a href="/for-us" onclick="collapseMenu()"><span class="navbar-text">ЗА НАС</span></a>
        ...
        <a href="/prices" onclick="collapseMenu()"><span class="navbar-text">ЦЕНИ</span></a>
        <a id="email-icon" href="/contacts" onclick="collapseMenu()"><i class="fa fa-fw fa-envelope"></i><span
                class="navbar-text">КОНТАКТИ</span></a>
    </div>
