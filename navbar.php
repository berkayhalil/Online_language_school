<div class="topnav" id="myTopnav">
    ...
    <div id="navbar-right">
        ...
        <a href="#courses" onclick="collapseMenu()"><span class="navbar-text">КУРСОВЕ</span></a>
        <a href="#prices" onclick="collapseMenu()"><span class="navbar-text">ЦЕНИ</span></a>
        <a id="email-icon" href="contacts.php" onclick="collapseMenu()"><i class="fa fa-fw fa-envelope"></i><span
